...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2015 at 03:33 PM
...
CREATE TABLE IF NOT EXISTS `giaithuong` (
  ...
  `MaHV` int(11) DEFAULT NULL,
  `MaTacPham` int(11) DEFAULT NULL,
  `NgayDatGiai` date NOT NULL,
  PRIMARY KEY (`MaGiaiThuong`),
  KEY `FK_2C2DF4A9DD199E24` (`MaTacPham`),
...
INSERT INTO `giaithuong` (`MaGiaiThuong`, `TenGiaiThuong`, `MaHV`, `MaTacPham`, `NgayDatGiai`) VALUES
(30000, 'Truyện ngắn xuất sắc nhất', 10000, 20001, '2014-12-16'),
(30001, 'Thông tin thời sự', 10001, 20010, '2015-05-23'),
(30002, 'Thông tin công nghệ', 10004, 20011, '2015-04-15');
...
INSERT INTO `hoivien` (`MaHV`, `TenDangNhap`, `MatKhau`, `HoTen`, `NgaySinh`, `GioiTinh`, `AnhDaiDien`, `QueQuan`, `Email`, `CMND`, `TieuSu`, `MaToaSoan`, `KichHoat`) VALUES
(10000, 'hungnv', 'hungnv123', 'Nguyễn Văn Hùng', '1989-04-15', 'Nam', NULL, 'Hà Nội', 'hungnv@gmail.com', 123432, 'Tốt nghiệp Học Viện Báo Chí và Tuyên Truyền. Từ khi tốt nghiệp đến nay làm việc tại tòa soạn báo HHT.', 30000, 1),
(10001, 'Linhbt', 'linhbt123', 'Bùi Thị Linh', '1975-04-08', 'Nữ', NULL, 'TP.Hồ Chí Minh', 'linhbt@gmail.com', 111234893, 'Tốt nghiệp ĐH Khoa Học Xã Hội Và Nhân Văn. Học Thạc sĩ tại Hàn Quốc. Từ khi về nước đến nay làm việc tại tòa soạn báo Dân Trí.', 30001, 1),
(10002, 'hoank', 'hoank123', 'Nguyễn Kiều Hoa', '1980-08-10', 'Nữ', NULL, 'Hà Nội', 'hoank@gmail.com', 121348769, 'Tốt nghiệp Đại Học Văn Hóa. Sau khi ra trường đến năm 2002, làm việc tại tòa soạn báo CAND. Từ năm 2002 đến nay làm việc tại tòa soạn báo Dân Trí.', 30001, 1),
(10003, 'hoangnv', 'hoangnv', 'Nguyễn Việt Hoàng', '1989-10-25', 'Nam', NULL, 'Hải Dương', 'hoangnv@gmail.com', 112345312, 'Tốt nghiệp Đại Học Hà Nội. Từ khi tốt nghiệp đến nay làm việc tại tòa soạn báo HHT.', 30000, 1),
(10004, 'khaibv', 'khaibv123', 'Bùi Văn Khải', '1970-01-02', 'Nam', NULL, 'Hà Nội', 'khaibv@gmail.com', 1112673212, 'Tốt nghiệp Học Viện Báo Chí và Tuyên Truyền. Từ khi tốt nghiệp đến năm 2010 làm việc tại tào soạn báo Hoa Học Trò. Từ năm 2010 đến nay, làm việc tại tòa soạn báo vnexpress.', 30003, 1),
(10005, 'lannn', 'lannn123', 'Nguyễn Ngọc Lan', '1980-04-15', 'Nữ', NULL, 'Hải Dương', 'lannn@gmail.com', 111562892, 'Tốt nghiệp Đại Học Khoa Học Xã Hội Và Nhân Văn. Từ khi tốt nghiệp đến nay, làm việc tại tào soạn báo Vietnamnet.', 30002, 1),
(10006, 'mainn', 'mainn123', 'Nguyễn Ngọc Mai', '1990-08-08', 'Nữ', NULL, 'Hà Nội', 'mainn@gmail.com', 111276526, 'Tốt nghiệp Đại Học Ngoại Ngữ. Từ khi tốt nghiệp đến nay làm việc tại tòa soạn báo HHT.', 30000, 1);
...
CREATE TABLE IF NOT EXISTS `tinhthanh` (
  ...
  `TenTinhThah` varchar(50) NOT NULL,
...
INSERT INTO `tinhthanh` (`MaTinhThanh`, `TenTinhThah`) VALUES
(50000, 'Hà Nội'),
...
--
ALTER TABLE `admin`
  ADD CONSTRAINT `FK_880E0D76BB87CF27` FOREIGN KEY (`MaHV`) REFERENCES `hoivien` (`MaHV`);
...
ALTER TABLE `giaithuong`
  ...
  ADD CONSTRAINT `FK_2C2DF4A9DD199E24` FOREIGN KEY (`MaTacPham`) REFERENCES `tacpham` (`MaTacPham`);
