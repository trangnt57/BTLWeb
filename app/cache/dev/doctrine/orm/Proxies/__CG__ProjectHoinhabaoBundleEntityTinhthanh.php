 ...
 */
class Tinhthanh extends \Project\HoinhabaoBundle\Entity\Tinhthanh implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tinhthanh $proxy) {
    ...
    public function setTentinhthah($tentinhthah)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTentinhthah', array($tentinhthah));

        return parent::setTentinhthah($tentinhthah);
    }
    ...
    public function getTentinhthah()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTentinhthah', array());

        return parent::getTentinhthah();
    }
    ...
    public function getMatinhthanh()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getMatinhthanh();
        }
